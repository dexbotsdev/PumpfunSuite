...
const createWalletMeta = async (req, res, next) => {
  try {
    ...
    const userId = req.body.walletMeta.userId;

    console.log(req.body.walletMeta)

    const queryToken = { mint: mint, userId: userId }
...
const claimFunding = async (req, res, next) => {
  try {
    ...
    let userId = req.body.fundsMeta.userId
...
const claimOneWallet = async (req, res, next) => {
  try {
    ...
    const queryWallet = { mint: mint, userId: userId, walletAddress: walletAddress }
