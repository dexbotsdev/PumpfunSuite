...
const getTokenMeta = async (req, res, next) => {
  try {
    ...
    let userId = req.query.userId
     ...
     console.log('Searching for Tokenmeta with given req.user ', userId);
    const query = { mint:mint , userId: userId}
...
const getMyBundles = async (req, res, next) => {
  try {
     ...
     console.log('Searching for bundles with given req.query.publicKey ', req.query.publicKey);
    const query = {creatorwallet: req.query.publicKey}
...
const postHandler = async (req, res, next) => {
  try {
    ...
    const query = {metadataUrl:preMeta.metadataUrl,createdBy: preMeta.createdBy}
